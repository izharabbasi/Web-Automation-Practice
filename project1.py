...
User_name = driver.find_element_by_xpath("(//div[@class='tutor-form-col-6'])[3]/div/input").send_keys('izharabbasi')
Email = driver.find_element_by_xpath("(//div[@class='tutor-form-col-6'])[4]/div/input").send_keys('izhar_abbasi.1@hotmail.com')
